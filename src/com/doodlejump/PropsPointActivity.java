...
public class PropsPointActivity extends Activity{
...
//		score1.setText(c.getString(0) + c.getString(1));
		...
		if (c.getCount() == 0) {
			Toast.makeText(PropsPointActivity.this, "沒有資料", Toast.LENGTH_LONG)
				.show();
		}
		else {
			c.moveToLast();
	...
	private Button.OnClickListener GamePage = new Button.OnClickListener(){
		...
		public void onClick(View v) { 
			intent.setClass(PropsPointActivity.this,LimitMode.class);
	...
	private Button.OnClickListener ChoicePage = new Button.OnClickListener(){
		@Override
		public void onClick(View v) {
			intent.setClass(PropsPointActivity.this,DifficultyActivity.class);
			startActivity(intent);
			finish();
		}
	};

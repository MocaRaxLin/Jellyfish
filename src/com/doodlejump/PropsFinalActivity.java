...
public class PropsFinalActivity extends Activity{
	...
	private static final String DB_FILE = "PropsPoint.db" , DB_TABLE = "PropsPoint";
	...
	private Button.OnClickListener GamePage = new Button.OnClickListener(){
		...
		public void onClick(View v) {
			intent.setClass(PropsFinalActivity.this,PropsMode.class);
	...
	private Button.OnClickListener PointPage = new Button.OnClickListener(){
		@Override
		public void onClick(View v) {
			intent.setClass(PropsFinalActivity.this,PropsPointActivity.class);
			startActivity(intent);
			finish();
		}
	};
	...
	private Button.OnClickListener DifficultyPage = new Button.OnClickListener()
	{
		public void onClick(View v)
		{
			intent.setClass(PropsFinalActivity.this,DifficultyActivity.class);
			startActivity(intent);
			finish();
		}
	};
	...
	private Button.OnClickListener inClickBtnAdd = new Button.OnClickListener(){
		...
		public void onClick(View v){
			...
			Toast.makeText(PropsFinalActivity.this, "儲存成功", Toast.LENGTH_LONG).show();
		}
	};
